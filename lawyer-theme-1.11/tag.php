...
<section class="section archive-section" style="padding: 6rem 1.5rem 4rem;">
    <div class="container">
        <header class="archive-header text-center mb-16">
            <p class="section-badge"><?php esc_html_e('Oznaka', 'lehoia'); ?></p>
            <h1 class="section-title font-serif"><?php single_tag_title(); ?></h1>
            <?php if (tag_description()) : ?>
                <p class="hero-description" style="color: hsl(var(--muted-foreground));"><?php echo tag_description(); ?></p>
            <?php endif; ?>
        </header>
        ...
        <?php else : ?>
            <div class="no-results" style="color: hsl(var(--muted-foreground));">
                <p><?php esc_html_e('Nema postova sa ovom oznakom.', 'lehoia'); ?></p>
            </div>
        <?php endif; ?>
    </div>
</section>
